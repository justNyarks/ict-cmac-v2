          ...
          <div className="relative z-10 h-full flex flex-col">
            <div className="space-y-6">
              ...
              <h2 className="text-6xl font-display font-extrabold text-white leading-[1.1] tracking-tight">
                Design the <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300 dark:from-[#2dd4bf] dark:to-[#93c5fd]">Future</span> <br/> with CMAC.
              </h2>
